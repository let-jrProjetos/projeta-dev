...
const ProjectFormPage = () => {
  ...
  const projectExemple = {
    ...
    beneficts:
      "| Participando do projeto voce irá desenvolver tanto suas hard skills quanto as softs |",
    ...
    <div className="bg-[#F6F5F4] flex flex-col items-center">
      <div className="bg-[#FFFFFF] font-Montserrat min-w-min rounded-xl m-10 px-12 py-12 flex flex-row flex-wrap justify-center gap-8">
        <img
          ...
          src={form.link === "" ? projectExemple.link : form.link}
          alt="Capa do Projeto"
        />
        <div className="text-black self-center ">
          <p className="font-Dela">
            {form.projectName === ""
              ? projectExemple.projectName
              : form.projectName}
          </p>
          <p>
          ...
          <p>
            {form.desiredOutcome === ""
              ? projectExemple.desiredOutcome
              : form.desiredOutcome}
          </p>
          <p>
            {form.beneficts === "" ? projectExemple.beneficts : form.beneficts}
          </p>
          <p>
            {form.schedule === "" ? projectExemple.schedule : form.schedule}
          </p>
      ...
      <form onSubmit={submitForm} className="font-Montserrat w-4/5 p-8">
        ...
        <div className="flex flex-row flex-wrap w-full mb-2">
          <label htmlFor="startDate" className="w-2/4 text-black">
            Data de Inicio:
          </label>
          <input
            id="startDate"
        ...
        <div className="flex flex-row flex-wrap w-full mb-2">
          <label htmlFor="dueDate" className="w-2/4 text-black">
            Data de Término:
          </label>
          <input
            id="dueDate"
        ...
        <label htmlFor="summary" className="text-black">
          Resumo:
        </label>
        <input
          id="summary"
        ...
        <label htmlFor="desiredOutcome" className="text-black">
          Objetivo do projeto:
        </label>
        <input
          id="desiredOutcome"
        ...
        <label htmlFor="beneficts" className="text-black">
          Benefícios em participar do projeto:
        </label>
        <input
          id="beneficts"
          name="beneficts"
        ...
        <label htmlFor="registrationDueDate" className="text-black">
          Data Limite de Inscriçāo:
        </label>
        <input
        ...
        <fieldset className="flex flex-wrap">
          <legend className="text-black">
            Escolha as linguagens que serão utilizadas:
          </legend>
        ...
        <div className="flex w-2/4 mb-2">
          <label htmlFor="otherLanguage" className="text-black mr-1">
            Outra:{" "}
          </label>
          <input
            id="otherLanguage"
